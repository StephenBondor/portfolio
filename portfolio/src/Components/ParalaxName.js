...
// These functions, getY and useY, are used to change state of Y according
// to the scrollY offset when it changes. They are needed to perform
...
// some serious confusion in the logic and future maintainability.
// Additionally, they remove the need to rely on libraries that were
// built to solve this problem in react, but having solved it, are almost
// not at all maintained, buggy as heck, and have caused someone
// else to build another library... which, having solved the problem, has
// again has fallen into disrepair. A vicious cycle.
